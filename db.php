...
// ******************************
 ...
 define( 'DB_HOSTNAME', '127.0.0.1' ); // set database host
 define( 'DB_USERNAME', 'root' ); // set database user
 define( 'DB_PASSWORD', '' ); // set database password
 define( 'DB_DATABASE', 'pirabook_pirabook' ); // set database name
...
// require dirname(__FILE__)."/exp/application/config/database.php";
// exit();
class DB
{
    private $link = null;
     ...
     *
     */
    public function get_one_result( $query, $object = false )
    {
        self::$counter++;
