<?php
	...
	class PhpAfly {
		...
		const SECRET_KEY = '1f53eeee-47bd-4fa2-a808-bef363f38b2f';
		// TODO: Replace following constant value with your public api key.
		const PUBLIC_KEY = 'ac1019b58c32d9a6ba019dd871a05b99';
		// TODO: Replace following constant value with your user id.
		const USER_ID = 11001345;
...
// 			// Shorten Url
            // $res = $ex->shorten(array('https://drive.google.com/open?id=0Byq3kPKFKG2bRGJIdS1mbWJxWFk'), 'adfly.local');
