...
// <creditNote>
    public function get_creditNote_amount($query_search){
    ...
    public function get_creditNote($start,$end,$query_search){
    ...
    // <email>
    $data[$key]["emails_sent"]=$this->email_model->get_dad_email("admin/sale/creditNote/",$row["id"]);
    // </email>
    ...
    public function get_creditNote_id($id){
...
// </client>
    ...
    $data["details_html"]=$this->article_model->get_details_by_id("credit_note",$data["id"]);
    ...
    // mismo registro
    public function record_same_creditNote($data,$id){
        $ac=false;
    ...
    public function update_creditNote($data,$id){
    ...
    public function insert_creditNote($data){
    ...
    public function creditNote_delete_it($id){
