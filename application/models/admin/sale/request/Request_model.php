...
// <request>
    public function get_request_amount($query_search){
    ...
    public function get_request($start,$end,$query_search){
    ...
    // <email>
    $data[$key]["emails_sent"]=$this->email_model->get_dad_email("admin/sale/request/",$row["id"]);
    // </email>
...
// </client>
    ...
    // <email>
    $data["emails_sent"]=$this->email_model->get_dad_email("admin/sale/request/",$data["id"]);
    // </email>

    $data["details_html"]=$this->article_model->get_details_by_id("request",$data["id"]);
    ...
    // mismo registro
    public function record_same_request($data,$id){
        $ac=false;
    ...
    public function request_delete_it($id){
