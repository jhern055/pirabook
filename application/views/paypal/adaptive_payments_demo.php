...
<p>
  ...
  <?php $this->load->view("paypal/convert_currency.php"); ?>
  <?php //highlight_file($_SERVER['DOCUMENT_ROOT'].'/demo/codeigniter/includes/convert_currency.php'); ?></p>
...
<p>
  ...
  <?php $this->load->view("paypal/pay_chained_demo.php"); ?>
</p>
