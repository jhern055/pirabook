<?php $sessioMode=$this->session->userdata("sessionMode_creditNote");?>
...
form.submit=function(mode,item){
	...
	// id_creditNote :"<?php  echo (isset($id)?$id:'');?>",
    ...
    buttons: {
        Si: function() {
			...
			$.ajax({
				    ...
				    url: url+"admin/sale/creditNote/creditNote_delete",
				    type: 'POST',
				    dataType: 'json',
				    data: {
				    	id:id
				    ...
				    success: function(response){
							...
							modal: true,
							    buttons: {
							        ...
							        if(response.status)
            						{window.location.href="<?php echo base_url().'admin/sale/creditNote/'; ?>";}
 ...
 obj.url="<?php echo base_url();?>";
	...
	$.ajax({
        ...
        data:{
        	...
        	module:"<?php echo encode_id('credit_note'); ?>",
