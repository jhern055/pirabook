...
$form["status"]=form_dropdown('status',$sys["forms_fields"]["credit_note_status"],$status,"id='status'");
...
$form["status"]=($status?array_search($status, array_flip($sys["forms_fields"]["credit_note_status"]) ):"");
