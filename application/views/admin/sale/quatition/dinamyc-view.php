<?php $sessioMode=$this->session->userdata("sessionMode_quatition");?>
...
form.submit=function(mode,item){
	...
	// id_quatition :"<?php  echo (isset($id)?$id:'');?>",
    ...
    buttons: {
        Si: function() {
			...
			$.ajax({
				    ...
				    url: url+"admin/sale/quatition/quatition_delete",
				    type: 'POST',
				    dataType: 'json',
				    data: {
				    	id:id
				    ...
				    success: function(response){
							...
							modal: true,
							    buttons: {
							        ...
							        if(response.status)
            						{window.location.href="<?php echo base_url().'admin/sale/quatition/'; ?>";}
...
$(document).on("click","div.articleListContainer > div.area2 > div.data > div.itemArticle > div.editionActions > button.cancel",function() {
 ...
 obj.url="<?php echo base_url();?>";
	...
	$.ajax({
        ...
        data:{
        	id: obj.id,
        	source_module:"quatition",
        	module:"<?php echo encode_id('quatition'); ?>",
