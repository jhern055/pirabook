...
<?php  echo form_open("form",$attributes_form);?>
                    ...
                    <div class="row">
                        ...
                        <label>Show 
                            <?php echo form_dropdown('show_amount_request',$sys["forms_fields"]["show_amount"], '10',"id='show_amount_request'"); ?>
                        </div>
                        </div>

                        <div class="col-sm-6">
                        <div id="dataTables-example_filter" class="dataTables_filter">
                        <label>Nombre:<?php echo form_input("input_search_request",$input_search_request," id=input_search_request"); ?></label>
                        </div>
                        </div>
                    </div>
...
<?php  echo form_close();?>
                    ...
                    <div class="dataTable_wrapper" id="div_table">
                            ...
                            <?php echo $this->load->view("admin/sale/request/ajax/table-request-view",$records_array,true); ?>
                    </div>
...
// // paginacion de ajax 
$(document).on("change", "select#show_amount_request", function() {
...
var formSearch=$("form.formAdminSaleAjax").serialize()+"&ajax=1";
    ...
    $.ajax({
        ...
        type: "GET",
        data: formSearch,
        url: "<?php echo base_url().$this->uri->uri_string."/request_ajax/"; ?>",
...
$(document).on("keyup", "input#input_search_request", function() {
...
//         type: "GET",
//         data:{ajax:1},
//         url: "<?php echo base_url().$this->uri->uri_string."/request_ajax/".(!empty($this->session->userdata('record_start_row_request'))?$this->session->userdata('record_start_row_request'):0 ); ?>",
//         beforeSend:function(html){
//         },
//         success: function(html) {
...
// paginacion de ajax 
$(document).on("click", "ul.admin_sale_request_request_ajax > li > a", function() {
...
var client_email=$(this).parent().parent().data("client_email"),
    ...
    $.ajax({
        ...
        id:id,
        source_module:"<?php echo encode_id('admin/sale/request/');?>",
        email:email,
        document_type:2,
