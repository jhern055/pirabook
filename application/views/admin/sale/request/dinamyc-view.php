<?php $sessioMode=$this->session->userdata("sessionMode_request");?>
...
form.submit=function(mode,item){
	...
	// id_request :"<?php  echo (isset($id)?$id:'');?>",
    ...
    buttons: {
        Si: function() {
			...
			$.ajax({
				    ...
				    url: url+"admin/sale/request/request_delete",
				    type: 'POST',
				    dataType: 'json',
				    data: {
				    	id:id
				    ...
				    success: function(response){
							...
							modal: true,
							    buttons: {
							        ...
							        if(response.status)
            						{window.location.href="<?php echo base_url().'admin/sale/request/'; ?>";}
 ...
 obj.url="<?php echo base_url();?>";
	...
	$.ajax({
        ...
        data:{
        	...
        	module:"<?php echo encode_id('request'); ?>",
