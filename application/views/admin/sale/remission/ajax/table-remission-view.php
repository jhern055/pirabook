        ...
        <div class="col-sm-12">
            ...
            <?php foreach($records_array as $rows): ?> 
                ...
                <tr class="gradeA odd" role="row" data-row_id="<?php echo encode_id($rows["id"]); ?>" data-client_email="<?php echo (!empty($rows["client_email"])?$rows["client_email"]:""); ?>">
                    <td class="center"><?php echo (!empty($rows["folio"])? anchor(base_url()."admin/sale/remission/remissionView/".$rows["id"],$rows["folio"]) :"&nbsp;") ?></td>
                    ...
                    <td class="center"><?php echo anchor(base_url()."admin/payment/admin/?source_module=".encode_id("admin/sale/remission/payment/")."&id=".encode_id($rows["id"])."&module=".encode_id("remission"),"<span class='payment_search'></span>",""); ?></td>
