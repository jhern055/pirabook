...
<?php  echo form_open("form",$attributes_form);?>
                    ...
                    <div class="row">
                        ...
                        <label>Show 
                            <?php echo form_dropdown('show_amount_remission',$sys["forms_fields"]["show_amount"], '10',"id='show_amount_remission'"); ?>
                        </div>
                        </div>

                        <div class="col-sm-6">
                        <div id="dataTables-example_filter" class="dataTables_filter">
                        <label>Nombre:<?php echo form_input("input_search_remission",$input_search_remission," id=input_search_remission"); ?></label>
                        </div>
                        </div>
                    </div>
...
<?php  echo form_close();?>
                    ...
                    <div class="dataTable_wrapper" id="div_table">
                            ...
                            <?php echo $this->load->view("admin/sale/remission/ajax/table-remission-view",$records_array,true); ?>
                    </div>
...
// // paginacion de ajax 
$(document).on("change", "select#show_amount_remission", function() {
...
var formSearch=$("form.formAdminSaleAjax").serialize()+"&ajax=1";
    ...
    $.ajax({
        ...
        type: "GET",
        data: formSearch,
        url: "<?php echo base_url().$this->uri->uri_string."/remission_ajax/"; ?>",
...
$(document).on("keyup", "input#input_search_remission", function() {
...
//         type: "GET",
//         data:{ajax:1},
//         url: "<?php echo base_url().$this->uri->uri_string."/remission_ajax/".(!empty($this->session->userdata('record_start_row_remission'))?$this->session->userdata('record_start_row_remission'):0 ); ?>",
//         beforeSend:function(html){
//         },
//         success: function(html) {
...
// paginacion de ajax 
$(document).on("click", "ul.admin_sale_remission_remission_ajax > li > a", function() {
