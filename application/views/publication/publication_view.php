...
<?php  echo form_open("form",$attributes_form);?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                        <div id="dataTables-example_filter" class="dataTables_filter">
                        <label>Rar Nombre:<?php echo form_input("input_search_rar_name",$input_search_rar_name," id=input_search_rar_name"); ?></label>
                        </div>
                        </div>
                        ...
                        <div id="dataTables-example_filter" class="dataTables_filter">
                        <label>Estatus:
                            <?php echo form_dropdown('publication_status',$sys["forms_fields"]["publication_status"], $publication_status,"id='publication_status'"); ?>
                        </div>
                        </div>

                        <div class="col-sm-6">
                        <div id="dataTables-example_filter" class="dataTables_filter">
                        <label>Id:<?php echo form_input("input_search_id",$input_search_id," id=input_search_id"); ?></label>
                        </div>
                        </div>
...
$(document).on("keyup", "input#input_search_id", function() {
...
$(document).on("keyup", "input#input_search_rar_name", function() {
...
$(document).on("change", "select#publication_status", function() {
