...
class Media
{
    ...
    static function mediaYoutube($url)
    {
        ...
        if (preg_match("/(.*?)v=(.*?)($|&)/i", $url, $matching)) {
            ...
            array_push($media, '<iframe id="' . date("YmdHis") . $vid . '" style="display: none; margin-bottom: 5px;" width="190" height="118" src="http://www.youtube.com/embed/' . $vid . '" frameborder="0" allowfullscreen></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaVine($url)
    {
        ...
        if ($breakUrl[2] != "") {
            ...
            array_push($media, '<iframe id="' . date("YmdHis") . $vid . '" class="vine-embed" src="https://vine.co/v/' . $vid . '/embed/simple" width="190" height="190" frameborder="0"></iframe><script async src="//platform.vine.co/static/scripts/embed.js" charset="utf-8"></script>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaVimeo($url)
    {
        ...
        if ($breakUrl[1] != "") {
            ...
            array_push($media, '<iframe id="' . date("YmdHis") . $imgId . '" style="display: none; margin-bottom: 5px;" width="190" height="280" src="http://player.vimeo.com/video/' . $imgId . '" width="654" height="118" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen ></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaMetacafe($url)
    {
        ...
        if ($matching[1] != "") {
            ...
            array_push($media, '<iframe id="' . date("YmdHis") . $vid . '" style="display: none; margin-bottom: 5px;" width="190" height="118" src="http://www.metacafe.com/embed/' . $vid . '" allowFullScreen frameborder=0></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaDailymotion($url)
    {
        ...
        if ($id != "") {
            ...
            array_push($media, '<iframe id="' . date("YmdHis") . $id . '" style="display: none; margin-bottom: 5px;" width="190" height="118" src="http://www.dailymotion.com/embed/video/' . $id . '" allowFullScreen frameborder=0></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaCollegehumor($url)
    {
        ...
        if ($id != "") {
            ...
            $hash = json_decode($hash, true);
            array_push($media, $hash['thumbnail_url']);
            array_push($media, '<iframe id="' . date("YmdHis") . $id . '" style="display: none; margin-bottom: 5px;" width="190" height="118" src="http://www.collegehumor.com/e/' . $id . '" allowFullScreen frameborder=0></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaBlip($url)
    {
        ...
        if ($url != "") {
            ...
            $src = $matching[1];
            array_push($media, $hash['thumbnail_url']);
            array_push($media, '<iframe id="' . date("YmdHis") . 'blip" style="display: none; margin-bottom: 5px;" width="190" height="118" src="' . $src . '" allowFullScreen frameborder=0></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
    ...
    static function mediaFunnyordie($url)
    {
        ...
        if ($url != "") {
            ...
            $src = $matching[1];
            array_push($media, $hash['thumbnail_url']);
            array_push($media, '<iframe id="' . date("YmdHis") . 'funnyordie" style="display: none; margin-bottom: 5px;" width="190" height="118" src="' . $src . '" allowFullScreen frameborder=0></iframe>');
        } else {
            array_push($media, "", "");
        }
        return $media;
