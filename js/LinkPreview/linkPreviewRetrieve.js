...
(function($) {
    $.fn.linkPreviewRetrieve = function(options) {
        ...
        $.get('../linkpreviewcontrol/retrieve', {}, function(answer) {
            // console.log(answer);
...
selector.append('<div class="previewPosted" style="">'
                    ...
                    +'<div class="previewContentPosted">'
                        +'<div class="previewTitlePosted" id="pTP_'+iframeId+'" style="width: 355px">'
                        +item.title
                        +'</div>'
                        +'<div class="previewUrlPosted">'
                        +item.canonicalUrl
                        +'</div>'
                        +'<div class="previewDescriptionPosted" id="pDP_'+iframeId+'" style="width: 355px">'
...
selector.append('<div class="previewPosted" style="">'
                    ...
                    +'<div class="previewContentPosted">'
                        ...
                        +'<a href="'+item.url+'" target="_blank">'
                        +'<span id="previewSpanTitle">'+item.title+'</span>'
                        +'</a>'
                    +'</div>'
                    +'<div class="previewUrlPosted">'
                    +item.canonicalUrl
                    ...
                    +'<div class="previewDescriptionPosted">'
                        +'<span id="previewSpanDescription">'
                        +item.description
                        +'</span>'
                    +'</div>'
                    +'<div style="clear: both"></div>'
